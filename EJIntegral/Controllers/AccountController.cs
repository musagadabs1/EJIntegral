    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(FormCollection model, string returnUrl)
        {
            ...
            var userViewModel = new LoginViewModel
            {
                ...
                Password = model["txtPassword"],
                RememberMe = false
            };

            // This doesn't count login failures towards account lockout
            // To enable password failures to trigger account lockout, change to shouldLockout: true
            var result = await SignInManager.PasswordSignInAsync(userViewModel.Username, userViewModel.Password, userViewModel.RememberMe, shouldLockout: false);
            switch (result)
            {
